...
function CaretakerMessages() {
  const [messages] = useState([
    {
      id: 1,
      from: 'Dr. Sarah Johnson',
      subject: 'Patient Update - Sarah Smith',
      content: 'The latest test results for Sarah Smith look good. Continue with the current medication schedule.',
      timestamp: '2024-03-20 09:30 AM',
      unread: true
    },
    {
      id: 2,
      from: 'James Smith (Patient)',
      subject: 'Medication Question',
      content: 'Need clarification about the new medication schedule.',
